...
function openFeedbackDetailScreen(feedbackId) {
    ...
    setTimeout(() => {
        ...
        if (memoBtn) {
            console.log('[교수 메모 버튼] 버튼 찾음, 메모 설정');
            memoBtn.setAttribute('data-memo', memo);
            console.log('[교수 메모 버튼] 메모 데이터 설정 완료:', memo ? '있음' : '없음');
        } else {
            ...
            <div class="px-6 py-3 border-b bg-white">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm text-gray-700 flex-1 mr-4">
                        ...
                        <span class="font-semibold">기본단계:</span> <span class="text-[#6A0028]">${request.basicStageName || request.stage || '-'}</span>
                        <span class="mx-2 text-gray-400">|</span>
