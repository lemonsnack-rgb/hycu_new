    ...
    detailView.innerHTML = `
        <div class="review-detail-content-wrapper">
            ...
            <div class="review-detail-header" style="padding: 12px 24px;">
                <button onclick="backToProfessorContentList('${contentType}')" class="back-to-list-btn">
            ...
            <div class="review-detail-body">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex justify-end gap-2 mt-6 pt-6 border-t">
                        <button onclick="backToProfessorContentList('${contentType}')" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                            목록
                        </button>
                    </div>
                </div>
