...
const appData = {
    schedules: [
        {
            id: 1,
            name: '2025-1학기 연구계획서 제출 및 심사',
            title: null,  // 사용자 지정 제목 (대시보드 표시용)
            category: '연구계획서',
            categoryType: 'evaluation',
            year: '2025',  // 학년도
            term: '1',  // 학기
            semester: '2025-1',  // 하위 호환용
            ...
            endDate: '2025-03-30',
            description: '1학기 연구계획서 제출 및 심사 기간',
            createdAt: '2025-01-10',
            createdBy: 'admin'
        },
        {
            id: 2,
            name: '2025-1학기 중간논문 제출 및 심사',
            title: null,  // 사용자 지정 제목 (대시보드 표시용)
            category: '중간논문',
            categoryType: 'evaluation',
            year: '2025',  // 학년도
            ...
            reviewEndDate: '2025-05-31',
            target: '전체',
            startDate: '2025-05-01',
            endDate: '2025-05-31',
            description: '1학기 중간논문 제출 및 심사 기간',
            createdAt: '2025-01-10',
            createdBy: 'admin'
        },
        {
            id: 3,
            name: '2025-1학기 예비심사 제출 및 심사',
            title: null,  // 사용자 지정 제목 (대시보드 표시용)
            category: '예비심사',
            categoryType: 'evaluation',
            year: '2025',  // 학년도
            ...
            reviewStartDate: '2025-10-16',
            reviewEndDate: '2025-10-31',
            target: '전체',
            startDate: '2025-10-01',
            endDate: '2025-10-31',
            description: '1학기 예비심사 제출 및 심사 기간',
            createdAt: '2025-01-10',
            createdBy: 'admin'
        },
        {
            id: 4,
            name: '2025-1학기 최종논문 제출 및 심사',
            title: null,  // 사용자 지정 제목 (대시보드 표시용)
            category: '최종논문',
            categoryType: 'evaluation',
            year: '2025',  // 학년도
            ...
            reviewStartDate: '2025-11-16',
            reviewEndDate: '2025-11-30',
            target: '전체',
            startDate: '2025-11-01',
            endDate: '2025-11-30',
            description: '1학기 최종논문 제출 및 심사 기간',
            createdAt: '2025-01-10',
            createdBy: 'admin'
        }
    ],
    ...
    evaluationCriteria: [
        {
            ...
            itemCount: 4,
            items: [
                { id: 1, name: '연구 주제의 적절성', score: 25, failScore: 15, description: '연구 주제의 타당성과 학술적 가치를 평가합니다.' },
                { id: 2, name: '연구 방법론', score: 25, failScore: 15, description: '연구 방법론의 적절성과 논리성을 평가합니다.' },
                { id: 3, name: '결과 분석', score: 25, failScore: 15, description: '연구 결과의 정확성과 분석의 타당성을 평가합니다.' },
                { id: 4, name: '논문 작성 완성도', score: 25, failScore: 15, description: '논문의 구성, 논리 전개, 문장력을 종합적으로 평가합니다.' }
            ],
            totalScore: 100,
            passCriteria: {
                type: 'committee',
        ...
        },
        {
            ...
            itemCount: 5,
            items: [
                { id: 1, name: '연구의 독창성', score: 25, failScore: 18, description: '연구의 참신성과 독창적 기여도를 평가합니다.' },
                { id: 2, name: '연구 방법론', score: 20, failScore: 14, description: '연구 방법론의 적절성과 엄밀성을 평가합니다.' },
                { id: 3, name: '학문적 기여도', score: 25, failScore: 18, description: '학문 발전에 대한 기여도와 영향력을 평가합니다.' },
                { id: 4, name: '논문 작성 완성도', score: 20, failScore: 14, description: '논문의 완성도와 학술적 글쓰기 수준을 평가합니다.' },
                { id: 5, name: '발표 능력', score: 10, failScore: 7, description: '논문 내용에 대한 이해도와 발표 능력을 평가합니다.' }
            ],
            totalScore: 100,
            passCriteria: {
                type: 'committee',
    ...
    committeeAssignmentData: [
        ...
        },
        {
            ...
            assignmentStatus: '배정 대기',
            advisorName: '정교수',
            thesisTitle: 'IoT 기반 스마트 홈 에너지 관리 시스템',
            submitDate: '2025-11-25'
        },
        {
            id: 'CA007',
            studentId: 'S007',
            studentNumber: '2024001240',
            studentName: '윤서영',
            academicYear: '2025',
            semester: '1',
            collegeType: '대학원',
            ...
            assignmentStatus: '배정 대기',
            advisorName: '신교수',
            thesisTitle: '사용자 경험 중심의 모바일 앱 인터페이스 디자인',
            submitDate: '2025-11-12'
        },
        {
            id: 'CA008',
            studentId: 'S008',
            studentNumber: '2024001241',
            studentName: '조현우',
            academicYear: '2024',
            semester: '2',
            collegeType: '대학원',
    ...
    professors: [
        ...
        { id: 'PROF011', employeeNumber: 'P2024003', name: '홍길동', department: '컴퓨터공학과', isTenured: true, email: 'hong@hycu.ac.kr', phone: '010-1111-1121' },
        { id: 'PROF012', employeeNumber: 'P2024004', name: '이순신', department: '기계공학과', isTenured: true, email: 'lee2@hycu.ac.kr', phone: '010-1111-1122' }
    ],

    // ========== 논문지도 일정 관리 현황 (학생별) ==========
    guidanceScheduleStatus: [
        { id: 1, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '공학부', major: '컴퓨터공학', degree: '석사', status: '재학', studentId: '2024001234', studentName: '김철수', professor: '홍길동', stage: '연구계획서', registrationStatus: '등록완료' },
        { id: 2, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '공학부', major: '컴퓨터공학', degree: '석사', status: '재학', studentId: '2024001235', studentName: '이영희', professor: '홍길동', stage: '연구계획서', registrationStatus: '미등록' },
        { id: 3, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '공학부', major: '전기전자공학', degree: '박사', status: '재학', studentId: '2023001100', studentName: '박민수', professor: '이순신', stage: '중간보고서', registrationStatus: '등록완료' },
        { id: 4, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '공학부', major: '기계공학', degree: '석사', status: '재학', studentId: '2024001236', studentName: '최지원', professor: '이순신', stage: '연구계획서', registrationStatus: '등록완료' },
        { id: 5, year: '2025', semester: '1', collegeType: '특수대학원', college: '경영대학원', faculty: '경영학부', major: '경영학', degree: '석사', status: '재학', studentId: '2024002001', studentName: '정수현', professor: '김교수', stage: '연구계획서', registrationStatus: '미등록' },
        { id: 6, year: '2025', semester: '1', collegeType: '특수대학원', college: '경영대학원', faculty: '경영학부', major: '경영학', degree: '석사', status: '재학', studentId: '2024002002', studentName: '강민지', professor: '김교수', stage: '최종논문', registrationStatus: '등록완료' },
        { id: 7, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '인문사회학부', major: '교육학', degree: '박사', status: '재학', studentId: '2022001001', studentName: '윤서준', professor: '박교수', stage: '최종논문', registrationStatus: '등록완료' },
        { id: 8, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '인문사회학부', major: '심리학', degree: '석사', status: '휴학', studentId: '2023002050', studentName: '조아름', professor: '윤교수', stage: '중간보고서', registrationStatus: '미등록' },
        { id: 9, year: '2024', semester: '2', collegeType: '일반대학원', college: '일반대학원', faculty: '공학부', major: '컴퓨터공학', degree: '석박통합', status: '재학', studentId: '2023001234', studentName: '신동욱', professor: '홍길동', stage: '중간보고서', registrationStatus: '등록완료' },
        { id: 10, year: '2024', semester: '2', collegeType: '특수대학원', college: '정보대학원', faculty: '정보학부', major: '정보보안', degree: '석사', status: '재학', studentId: '2024003001', studentName: '한지민', professor: '이교수', stage: '연구계획서', registrationStatus: '등록완료' },
        { id: 11, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '공학부', major: '화학공학', degree: '박사', status: '재학', studentId: '2022001500', studentName: '오현우', professor: '최교수', stage: '최종논문', registrationStatus: '등록완료' },
        { id: 12, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '자연과학부', major: '물리학', degree: '석사', status: '재학', studentId: '2024001300', studentName: '서은지', professor: '정교수', stage: '연구계획서', registrationStatus: '미등록' },
        { id: 13, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '자연과학부', major: '화학', degree: '박사', status: '재학', studentId: '2021001100', studentName: '노태현', professor: '최교수', stage: '최종논문', registrationStatus: '등록완료' },
        { id: 14, year: '2024', semester: '2', collegeType: '특수대학원', college: '디자인대학원', faculty: '디자인학부', major: '시각디자인', degree: '석사', status: '졸업', studentId: '2022003001', studentName: '문채원', professor: '송교수', stage: '최종논문', registrationStatus: '등록완료' },
        { id: 15, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '공학부', major: '건축공학', degree: '석사', status: '재학', studentId: '2024001400', studentName: '배성민', professor: '장교수', stage: '연구계획서', registrationStatus: '등록완료' },
        { id: 16, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '인문사회학부', major: '사회복지학', degree: '석사', status: '재학', studentId: '2024002100', studentName: '유지훈', professor: '임교수', stage: '중간보고서', registrationStatus: '미등록' },
        { id: 17, year: '2025', semester: '1', collegeType: '특수대학원', college: '경영대학원', faculty: '경영학부', major: '마케팅', degree: '석사', status: '재학', studentId: '2024002003', studentName: '황수정', professor: '김교수', stage: '연구계획서', registrationStatus: '등록완료' },
        { id: 18, year: '2024', semester: '2', collegeType: '일반대학원', college: '일반대학원', faculty: '공학부', major: '전기전자공학', degree: '석사', status: '수료', studentId: '2022001200', studentName: '안재욱', professor: '이순신', stage: '최종논문', registrationStatus: '등록완료' },
        { id: 19, year: '2025', semester: '1', collegeType: '일반대학원', college: '일반대학원', faculty: '공학부', major: '컴퓨터공학', degree: '박사', status: '재학', studentId: '2021001300', studentName: '송하늘', professor: '홍길동', stage: '최종논문', registrationStatus: '등록완료' },
