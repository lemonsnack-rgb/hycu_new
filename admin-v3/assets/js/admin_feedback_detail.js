                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="text-sm text-gray-600 flex-shrink-0">
                        <span class="font-semibold ${getPlagiarismColorClassReadOnly(request.copykillerScore, request.gptkillerScore)}">
                            CopyKiller: ${request.copykillerScore} <span class="text-gray-400 mx-1">/</span> GPT Killer: ${request.gptkillerScore} <a href="#" onclick="downloadPlagiarismReportReadOnly('combined', '${request.id}'); event.preventDefault();" class="ml-2 text-[#6A0028] hover:underline text-xs">결과보고서(통합)</a>
                        </span>
                    </div>
                </div>
            </div>
