                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex gap-2 flex-wrap mt-2">
                                ...
                                <button onclick="addMainComment('${comment.id}')" 
                                        class="text-xs bg-[#6A0028] text-white px-4 py-2 rounded-md hover:bg-[#5A0020] flex items-center gap-1 font-semibold">
            ...
            <div class="comment-bubble professor-main mb-2">
                ...
                <div class="mt-2">
                    ...
                    <button onclick="updateGeneralFeedback()" 
                            class="text-xs bg-[#6A0028] text-white px-3 py-1 rounded-md hover:bg-[#5A0020] mt-2 flex items-center gap-1">
                        <i class="fas fa-save"></i>
                        <span>수정</span>
                    </button>
                </div>
        ...
        <div class="space-y-2">
            ...
            <div class="flex gap-2">
                <button onclick="saveEditQuickMark('${id}')" 
                        class="text-xs bg-[#6A0028] text-white px-3 py-1 rounded-md hover:bg-[#5A0020]">
                    저장
                </button>
