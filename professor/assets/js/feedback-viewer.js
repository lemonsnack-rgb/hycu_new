            ...
            <div class="flex items-center justify-between p-4 border-b bg-white">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button onclick="completeFeedback()" 
                            class="text-sm bg-[#009DE8] text-white px-4 py-2 rounded-md hover:bg-[#0087c9] flex items-center gap-2 font-semibold transition-colors">
                        ...
                        <div id="general-feedback-tab">
                            ...
                            <div id="general-feedback-input-section" class="relative">
                                ...
                                <div class="flex gap-2 mt-2 flex-wrap">
                                    <button onclick="addGeneralFeedback()" class="text-xs bg-[#009DE8] text-white px-3 py-1.5 rounded-md hover:bg-[#0087c9] flex items-center gap-1">
